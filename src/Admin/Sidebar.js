                        ...
                        <div className="tab-pane stretchRight active" id="dashboard">
                            <div className="menu">
                                <ul className="list">
                                    ...
                                    <li><a href="/book_appointment"><i className="zmdi zmdi-calendar-check" /><span>Appointment</span> </a></li>
                                    <li><a href="javascript:void(0);" className="menu-toggle"><i className="zmdi zmdi-account-add" /><span>Doctors</span> </a>
                                        <ul className="ml-menu">
                                            <li><a href="/Doctor1">All Doctors</a></li>
                                            <li><a href="/All_appointment2">All_appointment2</a></li>
                                            <li><a href="/All_doctor2">All_Doctor2</a></li>
                                            <li><a href="/Add_doctor">Add Doctor</a></li>
                                            <li><a href="/Profile">Doctor Profile</a></li>
                                    ...
                                    <li><a href="javascript:void(0);" className="menu-toggle"><i className="zmdi zmdi-account-o" /><span>Patients</span> </a>
                                        <ul className="ml-menu">
                                            ...
                                            <li><a href="/Patient_invoice">Invoice</a></li>
                                        </ul>
                                    </li>
